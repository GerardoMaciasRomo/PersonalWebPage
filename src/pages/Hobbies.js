        ...
        <div
            ...
            <div class="relative">
                <div class="absolute -inset-1">
                    <div
                        class="w-full h-full rotate-180 opacity-100 blur-lg filter bg-gradient-to-r from-cyan-500 via-purple-600 to-indigo-700">
                    </div>
                </div>
            ...
            <div class="relative">
                <div class="absolute -inset-1">
                    <div
                        class="w-full h-full rotate-180 opacity-100 blur-lg filter bg-gradient-to-r from-indigo-700 via-purple-600 to-cyan-500">
                    </div>
                </div>
                <div class="transition-transform duration-400 relative overflow-hidden bg-gradient-to-br from-zinc-300 to-zinc-50 shadow-md rounded-xl h-full hover:scale-103">
                    <div class="p-9"><svg class="w-12 h-12 mx-auto text-gray-400 sm:mx-0" viewBox="0 0 24 24"
